        ...
        <div className="relative flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
          <div className="flex-1 px-3 bg-app-bg divide-y space-y-1">
            <ul className="space-y-2 pb-2">
              <li>
                <Link to ="/AiDashboard" className="text-base text-gold-500 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
              ...
              <li>
                <Link to ="https://mudrafi.vercel.app/" target="_blank" className="text-base text-gold-500 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group">
